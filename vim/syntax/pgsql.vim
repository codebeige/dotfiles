...
syn keyword pgsqlKeyword	 INCREMENT START MAXVALUE MINVALUE CACHE
syn keyword pgsqlKeyword	 OWNER OIDS RETURNING RAISE NOTICE
syn keyword pgsqlKeyword	 COMMIT COST SECURITY INVOKER VOLATILE

" Special values
syn keyword pgsqlSpecial	 FALSE TRUE NULL
...
syn keyword pgsqlType		 text tsvector txid_snapshot
syn keyword pgsqlType		 unknown uuid void varying with without
syn keyword pgsqlType		 xml xid zone
syn keyword pgsqlType		 float double precision real timestamp
...
syn keyword pgsqlOperator	 BETWEEN NOT AND OR IS IN LIKE ILIKE REGEXP RLIKE BINARY EXISTS
