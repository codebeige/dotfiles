...
local a, cmp, luasnip, nvim, _ = autoload("aniseed.core"), autoload("cmp"), autoload("luasnip"), autoload("aniseed.nvim"), nil
_2amodule_locals_2a["a"] = a
_2amodule_locals_2a["cmp"] = cmp
_2amodule_locals_2a["luasnip"] = luasnip
_2amodule_locals_2a["nvim"] = nvim
_2amodule_locals_2a["_"] = _
local labels = {buffer = "b", cmdline = "q", conjure = "c", luasnip = "s", nvim_lsp = "l", path = "p"}
...
local function config()
  ...
  cmp.setup({experimental = {ghost_text = true}, formatting = {fields = {"abbr", "kind", "menu"}, format = format}, mapping = mapping, snippet = {expand = _6_}, sources = {{name = "luasnip"}, {name = "buffer"}, {name = "nvim_lsp"}, {name = "conjure"}, {name = "path"}}})
