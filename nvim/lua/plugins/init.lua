...
local function _1_(use)
  ...
  use("hrsh7th/nvim-cmp", {after = {"LuaSnip", "nvim-treesitter"}, config = config("cmp"), requires = {"hrsh7th/cmp-buffer", "hrsh7th/cmp-cmdline", "hrsh7th/cmp-nvim-lsp", "hrsh7th/cmp-path", "PaterJason/cmp-conjure", "saadparwaiz1/cmp_luasnip"}})
